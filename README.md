...
Note - Create a Project on firebase and obtain Api Key.
  You must create a File Keys.js in src/ directory with following content and put api key in quotes.
  export const FIREBASE_API_KEY = "Api Key";
